...
const ContactsContent = () => {
  ...
  return (
    <div className='center-shadow flex-none flex h-fit bg-sky-950 border-t-2 border-cyan-400 px-5 py-5 font-mono text-sky-200'>
      <div className='flex-none font-mono text-3xl text-center content-center drop-shadow-glow text-sky-300 mr-4'>CONTACT ME:</div>
      <div className='flex-auto grid grid-cols-3 gap-1 gap-y-3'>
