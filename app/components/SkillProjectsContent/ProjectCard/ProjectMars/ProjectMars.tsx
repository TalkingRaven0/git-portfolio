    ...
    const description = (
        <div className='m-4 h-fit'>
            ...
            <p>
                ...
                After finishing a big portion of the project, while I had no pending tasks in my side since I was now waiting for the API to be developed, I worked on translating the whole website into using Next.JS, React.JS, and Tailwind whenever I didn't have other tasks that needed attention.
            </p>
